...
@Component({
  selector: 'app-apply-new-renewal',
  templateUrl: './apply-new-renewal.component.html',
  styleUrls: ['./apply-new-renewal.component.scss']
})
export class ApplyNewRenewalComponent implements OnInit {
    ...
    this.tenderService.tenderRenewalReregNewRecord(data)
      .subscribe(
        req => {
          ...
          let token = req['token'];
          this.router.navigate(['/home/tenders/renewal/apply/' + this.tender_id + '/' + token ]);
