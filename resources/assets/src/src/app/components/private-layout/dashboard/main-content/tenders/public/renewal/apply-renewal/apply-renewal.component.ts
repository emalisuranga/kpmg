...
@Component({
  selector: 'app-apply-renewal',
  templateUrl: './apply-renewal.component.html',
  styleUrls: ['./apply-renewal.component.scss']
})
export class ApplyRenewalComponent implements OnInit {
  ...
  applyTender: IapplyTender = {
    ...
    id: null,
    total_contract_cost : null,
    value_of_work_completed : null,
    total_payment_received_for_work_completed : null,
    nature_of_sub_contract : null,
    name_of_sub_contract : null,
    nationality_of_sub_contract : null,
    total_cost_of_sub_contract: null,
    amount_of_commission_paid : null,
    address_of_sub_contract : null,
    duration_of_sub_contract: null,
  };
  ...
  getRenewalRequestTender() {
    ...
    this.tenderService.tenderRenwalGet(data)
      .subscribe(
        req => {
  ...
  pay() {
    ...
    if (this.renewalStatus === 'TENDER_RENEWAL_PCA3_PENDING') {
      feeType = 'PAYMENT_TENDER_PCA3_RENEWAL';
      moduleType = 'MODULE_TENDER_RENEWAL_PCA3';
      paymentDes = 'PCA3 Renewal';
    }
    if (this.renewalStatus === 'TENDER_RENEWAL_PCA4_PENDING') {
      feeType = 'PAYMENT_TENDER_PCA4_RENEWAL';
      moduleType = 'MODULE_TENDER_RENEWAL_PCA4';
      paymentDes = 'PCA4 Renewal';
    }
