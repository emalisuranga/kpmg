...
import { APIForm23Connection } from './services/connections/APIForm23Connection';
...
import { Form23Service } from './services/form23.service';
import { environment } from '../../../../../../environments/environment';
import { IShareRegisters, IShareRegister, IAnnualRecords, IAnnualRecord, IAnnualAuditors, IAnnualAuditor, IAnnualCharges, IAnnualCharge, IDownloadDocs, IUploadDocs, IShareRecords, IShareRecord, ICompanyOldRecord, IbulkShareholderBulkInfo, IAnnualReturnDatesInfo, IAlterOptions, IremoveUserInfo } from './models/form23.model';
@Component({
  selector: 'app-alterations-of-offshore-company',
  templateUrl: './alterations-of-offshore-company.component.html',
  styleUrls: ['./alterations-of-offshore-company.component.scss']
})
export class AlterationsOfOffshoreCompanyComponent implements OnInit, AfterViewInit {
...
total_with_vat_tax = 0;
  ...
  constructor(
    ...
    private annualService: Form23Service,
    ...
    this.annualService.annualData(data)
      .subscribe(
        req => {
          ...
          if ( !( this.annualReturnStatus === 'OFFSHORE_ALTERATIONS_PROCESSING' || this.annualReturnStatus === 'OFFSHORE_ALTERATIONS_RESUBMIT' ) ) {
            this.spinner.hide();
            this.router.navigate(['/dashboard/home']);
            return false;
          }

          if (this.annualReturnStatus === 'OFFSHORE_ALTERATIONS_RESUBMIT' ) {
        ...
        this.hasRequestForAddress = req['data']['has_request_for_address'] ?  true : false;
          ...
          this.otherFilesUploadedAtLeast = this.otherUploadList['uploadedAll'];
    ...
    this.annualService.addNewSec(data)
      .subscribe(
        req => {
          ...
          // tslint:disable-next-line:max-line-length
          this.sec = { id: 0, showEditPaneForSec: 0, type: 'local', secType: 'natural', title: '', firstname: '', lastname: '', province: '', district: '', city: '', localAddress1: '', localAddress2: '', postcode: '', nic: '', passport: '', country: '', share: 0, date: '', occupation: '', isReg: false, regDate: '', phone: '', mobile: '', email: '', benifOwnerType : 'local', screen1Districts: [], screen1Cities: [], validateSecShBenifInEdit : false, secBenifList : { ben : [] } , forAddress1: '', forAddress2: '', forPostcode: '', forProvince: '', forCity: '', passport_issued_country: '', firm_date : '' , other_relevent: ''};
...
/**************End SHARE Functions*******************/
  ...
  pay() {
    ...
    if (this.form45_payment_enable) {
      this.paymentItems.push(
        {
            fee_type: 'PAYMENT_OFFSHORE_FORM45',
    ...
    if (this.form46_payment_enable) {
      this.paymentItems.push(
        {
            fee_type: 'PAYMENT_OFFSHORE_FORM46',
    ...
    const buy: IBuy = {
      module_type: 'MODULE_OFFSHORE_ALTERATIONS',
