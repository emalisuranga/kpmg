...
import { APIform39Connection } from './connections/APIform39Connection';
...
import {  IremoveAnnualDoc, Iresubmit, ISubmitCallRecords, IremoveCallShareDoc, ISubmitRegisterOfChargesRecords, IRemoveOtherDoc, ISubmitCapital, IupdateCourtDetails } from '../models/form39Model';

@Injectable({
  providedIn: 'root'
})
export class Form39Service {
