...
@Component({
  selector: 'app-renewal-resubmit-auditor-firm',
  templateUrl: './renewal-resubmit-auditor-firm.component.html',
  styleUrls: ['./renewal-resubmit-auditor-firm.component.scss']
})
export class RenewalResubmitAuditorFirmComponent implements OnInit {
        ...
        req => {
          if (req['status']) {
            if (req['data']['file']) {
              ...
              this.gotoSubmit(this.application);
            }
          }
        }
      );
