...
import { APICallOnShareConnection } from './connections/APICallOnShareConnection';
...
import {  IremoveAnnualDoc, Iresubmit, ISubmitCallRecords, IremoveCallShareDoc, IRemoveOtherDoc, IupdateCourtDetails } from '../models/callOnShare.model';

@Injectable({
  providedIn: 'root'
})
export class CallOnShareService {
