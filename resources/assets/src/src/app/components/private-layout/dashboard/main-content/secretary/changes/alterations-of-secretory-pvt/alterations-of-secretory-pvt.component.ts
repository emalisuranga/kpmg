...
@Component({
  selector: 'app-alterations-of-secretory-pvt',
  templateUrl: './alterations-of-secretory-pvt.component.html',
  styleUrls: ['./alterations-of-secretory-pvt.component.scss']
})
export class AlterationsOfSecretoryPvtComponent implements OnInit, AfterViewInit {
  ...
  progress = {
    ...
    stepArr: [
      ...
      { label: 'Alter Directors/Secretaries', icon: 'fas fa-users', status: '' },
      ...
      .subscribe(
        req => {
          ...
          for ( let i in this.partnerList.partner ) {
            ...
            if (this.partnerList.partner[i].registeredSec) {
              this.regPartnerNICs.push(this.partnerList.partner[i].nic.toUpperCase() );
            }
          }
