import { IGNdivision, ICountry, ISelectedAdminCompanies } from './../../../../http/models/general.model';
...
@Component({
  selector: 'app-non-sri-lankan-other-stakeholder',
  templateUrl: './non-sri-lankan-other-stakeholder.component.html',
  styleUrls: ['./non-sri-lankan-other-stakeholder.component.scss']
})
export class NonSriLankanOtherStakeholderComponent implements OnInit {
