...
@Component({
  selector: 'app-non-sri-lankan-company-admin',
  templateUrl: './non-sri-lankan-company-admin.component.html',
  styleUrls: ['./non-sri-lankan-company-admin.component.scss']
})
export class NonSriLankanCompanyAdminComponent implements OnInit {
