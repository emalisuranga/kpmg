<!DOCTYPE html>
    ...
    <body>
        <section class="form-body">
            ...
            <br>
            <p>
                    We,(note) &nbsp;<b> <?php foreach($member as $item){ if($item['comdesignation'] == "Director"){ echo $item['first_name'];} }  ?> &nbsp; <?php foreach($member as $item){ if($item['comdesignation'] == "Director"){ echo $item['last_name'];} }  ?> </b> &nbsp; of &nbsp; <b> <?php foreach($member as $item){ if($item['comdesignation'] == "Director"){ echo $item['address'];} }  ?></b>
                    Director of &nbsp; <b> <?php echo $comName; ?>&nbsp;<?php echo $comPostfix; ?></b> and &nbsp; <b><?php echo $sec['first_name']; ?>&nbsp;<?php echo $sec['last_name']; ?> </b> &nbsp;
                    of &nbsp; <b> <?php echo $sec['address']; ?> </b> &nbsp; the Secretary thereof do hereby make oath and
                    say solemnly sincerely and truly affirm and state that the particulars (note 1a) contained in the
