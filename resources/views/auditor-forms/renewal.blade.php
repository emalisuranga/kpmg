...
<body>  
    ...
    <tr>
        ...
        <div align="center"><b><span style="font-size: 12px">APPLICATON FOR RENEWAL OF CERTIFICATE OF REGISTRATION AS AN AUDITOR - INDIVIDUAL</span></b></div><br>
        ...
        <div style="padding-top:40px;">  *I enclose</div>
        <div style="padding-top:2px;">    (*Money Order)</div>
        <div style="padding-top:2px;">  (*Postal Order)</div><br> -->
        
        <div style="padding-left:-5px;">Apply for Renewal of *my Certificate of Registration No.</div><br>
        <div><b> <?php echo $regnum;?></b> of <b> <?php echo $name;?></b> &nbsp; <?php
            ...
            <div> Renewal Year :- <?php echo $year1;?> </div>
            <div> Tel :- <?php echo $telephone;?> </div>
            <div> Email :- <?php echo $email;?></div>
        
        {{-- <div style="padding-left: 150px; padding-top:-35px;">  </div><br> --}}
        <!-- <div>I Trading under the name, firm and style of</div><br>
        <div>Hereby declare that </div><br> -->
        <!-- <div>*(a) none of the particulars stated in my original application for registration has changed.</div><br>
        <div>(b) The particulars that have changed from those stated in my original application are : -</div><br><br> -->
        <br>
        <br>
