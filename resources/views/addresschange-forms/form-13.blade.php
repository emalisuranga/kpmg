    ...
    <section class="form-body">
        <header class="form-header">
            ...
            <table width="100%" >
                <tbody>
                    <tr>
                        <td width="28%" height="50" class="bg-color">Address of New Registered Office</td>
                        <td width="72%" height="50"><?php
                            // $line1 = $address1 . ',';
                            // $line2 = $address2 . ',';
                            // $city = $city;
                            // $district = $district;
        ...
        <table  width="100%">
            <tbody>
                ...
                <tr  >
                    ...
                    <td width="80%" height="80"> <?php echo $memFirstName; ?>&nbsp;<?php echo $memLastName; ?></td>
                </tr>
            </tbody>
        </table>
        <br>
