    ...
    <body>
        ...
        ?>
            ...
            <table width="100%" style="border:0; padding:0;" autosize="1">
                <tr>
                    ...
                    <td width="50%" style="border:0; font-size: 18px; padding-top:20px; padding-left:50px;" align="center"><span><b>FORM 23<br><br></b></span><p style="font-size: 13px; ">NOTICE OF</p><p style="font-size:16px;"><b>AMENDMENTS OR ALTERATIONS OF PARTICULARS OF <br>AN OFF-SHORE COMPANY </b></p></td>
                    <td width="10%" style="border:0; padding:0px; font-size: 10px;" align="left">(Section 261(3))</td>
                    <td width="20%" style="border:0; padding:0px;"><img width="130" height="auto" src="{{  URL::to('/') }}/images/eroc.png" alt="Logo EROC"></td>
                </tr>
                
                <tr>
                    <td colspan="4" align="center" style="border:0; padding:0px; font-size:13px;">Section 261(3) of the Companies Act No.  7 of 2007</td>
                </tr>
            </table>
            ...
            <table style="border: 0;" width="100%" autosize="1">
                <tbody>
                    <tr>
                        <td width="23%" height="30" class="bg-color">Name of the Company</td>
                        <td width="77%" height="30"><?php echo ($company_info->name) ? $company_info->name.' '.$postfix : '' ?></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="border: 0;" width="100%" autosize="1">
                <tbody>
                    <tr>
                        <td style="border: 0;" >(1)	Return of amendment of charter, statute, or memorandum and articles of association of the company or other instrument constituting or defining the constitution of the company.</td>
                    </tr>
                </tbody>
            </table>
            <br/>
		...
		<table  width="100%" height="50.4" style="border:0" autosize="1">
			...
			<table  width="100%" height="50.4" style="border:0" autosize="1">
                <tbody>
				    <tr>
                        <td style="border:0"><span style=" word-break: break-all; text-align:justify">Annex a copy of the altered charter, statute, or memorandum and articles of association of the company or other 
                        instrument constituting or defining the constitution of the company and where such instrument is not in an official 
                        language or in English, along with a translation of such instrument in English.</span></td>
                    </tr>
            	</tbody>
            </table>
            ...
            <table style="--primary-text-color: #212121; border:0" width="100%" autosize="1">
                <tbody>
                    <tr>
                        <td style="border:0" colspan="3">(2)   Return of alteration of Directors of the Company or their particulars</td>
                    </tr>
                    <tr>
                        <td width="127pt"  class="bg-color">Full name of <br>Director(s) *</td>
                        <td width="128pt"  class="bg-color">Residential Address</td>
                        <td width="127pt"  class="bg-color">Other business or occupation</td>
                        <td width="127pt"  class="bg-color">State changes giving date of changes</td>
                    </tr>
                    ...
                    if(count($director_changes)) { 
                    foreach($director_changes as $director) {
                        ?>

                      <tr height="100">
                        <td width="127pt" height="270"><?php echo $director['full_name'];?></td>
                        <td width="127pt" height="270">
                        ...
                        <td width="127pt" height="270"><?php echo $director['occupation']; ?></td>
                        <td width="127pt" height="270"><?php
                    ...
                    <tr>
                        <td width="127pt" height="270"></td>
                        <td width="128pt" height="270"></td>
                        <td width="127pt" height="270"></td>
                        <td width="127pt" height="270"></td>
                    </tr>
                    <?php 
        ...
        <br/>
            ...
            <table style="--primary-text-color: #212121; border:0 " width="100%" autosize="1">
                <tbody>
                    <tr>
                        <td style="border:0" colspan="4">(3) Return of alteration of authorized representative of the company in Sri Lanka or his particulars.</td>
                    </tr>
                    <tr>
                        <td width="127pt"  class="bg-color">Full name of authorised representative *</td>
                        <td width="128pt"  class="bg-color">Residential Address</td>
                        <td width="127pt"  class="bg-color">Nationality</td>
                        <td width="127pt"  class="bg-color">State changes giving date of changes</td>
                    </tr>
                ...
                $sec_changes = $stakeholder_changes[1];
                 ...
                 if(count($sec_changes)) { 
                    foreach($sec_changes as $sec) {
                      ...
                      <tr height="100">
                        <td width="127pt" height="150px"><?php echo $sec['full_name'];?>(<?php echo $sec['stakeholder_type'];?>)</td>
                        <td width="128pt" height="150px">
                        ...
                        <td width="127pt" height="150px"><?php echo $sec['nationality']; ?></td>
                        <td width="127pt" height="150px"><?php
                  ...
                  <tr>
                        <td width="127pt" height="150px">&nbsp;</td>
                        <td width="128pt" height="150px">&nbsp;</td>
                        <td width="127pt" height="150px">&nbsp;</td>
                        <td width="127pt" height="150px">&nbsp;</td>
                    </tr>
                    <?php 
            ...
            <table style="border: 0;" width="100%" autosize="1">
                <tbody>
                    ...
                    <tr>
                        <td style="border: 0;" colspan="2">(4) Return of alteration of situation of Registered office of the Company in the country of incorporation.</td>
                    </tr>
                    <tr>
                        <td width="153pt"  height="100px" align="left" class="bg-color" >Previous Address</td>
                        <td >
                    ...
                    <tr>
                        <td width="153pt" height="100px"  align="left" class="bg-color" >New Address</td>
                        <td >
        ...
        ?>
            ...
            <table  width="100%" height="50.4" style="border:0" autosize="1">
                <tbody>
                    <tr>
                        <td height="30" align="center" style="border:0">Date of change Address</td>
                        <td width="8%" style="border:0"    ></td>
                    <td width="5%" style="text-align:center;"><?php echo isset($d[0]) ? $d[0] : '' ; ?></td>
                    <td width="5%" style="text-align:center;"><?php echo isset($d[1]) ? $d[1] : '' ; ?></td>
                    <td width="10%"  style="border:0"   ></td>
            ...
            <table style="border: 0;" width="100%" autosize="1">
                <tbody>
                    <tr>
                        <td style="border:0" colspan="2">(5) Return of alteration of Situation of the office of the Company in Sri Lanka.</td>
                    </tr>
                    <tr>
                        <td width="153pt"  height="100px" align="left" class="bg-color">Previous Address</td>
                        <td >
